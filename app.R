     ...
     tabPanel("Información",
              sidebarLayout(
                  sidebarPanel(
                     ...
                     h5("En esta aplicación podrás decidir el ", strong("porcentaje de participación"), " que habrá, el porcentaje de ", strong("voto"), " que se lleva cada ", strong("partido"),
                        " y, si quieres, el de ", strong("voto en blanco y nulo"),". 
     ...
     tabPanel("Resultados Exactos",
              ...
              sidebarLayout(
                  ...
                  mainPanel(
                      ...
                      flowLayout(
                          textInput("PP","PP",value =  "30,4"),
                          textInput("PSOE","PSOE", value =  "27,89"),
                          textInput("MM","Más Madrid", value =  "17,6"),
                          textInput("Vox","Vox", value =  "8,32"),
                          textInput("UP","Unidas Podemos", value =  "6,58"),
                          textInput("Cs","Ciudadanos", value =  "5,11") 
              ...
              sidebarLayout(
                  ...
                  mainPanel(
                      ...
                      h6("Soy Romén Adán, politólogo por la U. Pompeu Fabra y estudiante de Máster en Análisis Político y Electoral en la Carlos III.
                         Es la primera app que desarrollo, así ni es lo más visual ni lo más cómoda que habrás visto. Pero espero que te haya sido útil y te haya picado
                         un poco la curiosidad por seguir la campaña. Si quieres indagar en el código de R para crearla puedes verlo en mi ",
                         a(href="https://github.com/Adan-gz/D_hondt-Madrid/blob/main/app.R", 
                           "github"),". Y si tienes consejos para mejorarlo son más que bienvenidos."),
                     br(),
